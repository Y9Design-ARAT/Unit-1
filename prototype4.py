...
def pressBtn3():
    num1 = (number1.get())
    result = int(num1) * 1000000
    label2.config(text="Result is %d" % result + "milimeters")
...
# Here we create a button that will convert to meters
button1 = tk.Button(tab1, text="Metres", command = pressBtn1)
button1.grid(row=3, column=2)

# Here we create another button that will convert to cenimeters
button2 = tk.Button(tab1, text="Centimetres", command = pressBtn2)
button2.grid(row=4, column=2)

# Here we create a buttin that will convert km to Milimeters
button3 = tk.Button(tab1, text="Milimetres", command = pressBtn3)
